...
// Adaptations by Johnn Keefe
// http://johnkeefe.net
// To build a "sleep monitor" that I tied to my wrist with a sock.
// The setup uses the TinyDuino's base shield, accellerometer shield and SD card shield
...
void loop() {
  ...
  // we get this far every minute or so,
  // after 12 loops that delay 5 seconds
